    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex flex-wrap gap-2 bg-gray-200 rounded-xl p-1">
            {["all", "active", "inactive", "upcoming", "past", "draft"].map(
              (tab) => (
                <button
                  key={tab}
          ...
          <select
            ...
            className="w-full sm:w-1/6 border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-red-500 focus:border-red-500"
          >
            <option value="createdAt-asc">Sort by Created (Newest)</option>
            <option value="createdAt-desc">Sort by Created (Oldest)</option>
          </select>

          <div className="w-full sm:w-1/3 flex gap-2 pl-[8vw]">
            <input
              type="date"
                ...
                <div className="flex justify-between items-center mt-4">
                  ...
                  <div className="flex space-x-2">
                    ...
                    {event.type === "configure" && (
                      <Link
                        to={{
                          pathname: `/seat-config/${event._id}`,
                    ...
                    <button
                      ...
                      className="text-red-600 hover:text-red-400 border p-1.5 rounded-lg"
                    >
