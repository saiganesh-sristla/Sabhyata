      ...
      <div className="hidden md:block w-1/2 h-full">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12">
          <img
            ...
            alt="Sabhyata Logo"
          />
          <h2 className="text-2xl font-bold text-gray-900 text-center">Get Started Now</h2>
          <p className="text-gray-500 text-center mt-1 mb-6">Please log in to your account to continue.</p>
